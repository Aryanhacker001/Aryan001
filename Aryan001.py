...
import zlib
import base64
os.system('espeak -a 300 "WELCOME TO RAYEE JANAN RANDOM CLONING TOOLS"')
...
\033[1;90m══════════════════════════════════════════════════════════════════════
\033[1;92m[+] AUTHOR    :  Aryan
\033[1;92m[+] GITHUB    :  
\033[1;92m[+] FACEBOOK  :  
\033[1;92m[+] WHATSAPP  :  +93787044335
\033[1;92m[+] TELEGRAM  :  https://t.me/
\033[1;92m[+] TOOLS     :  Trial
...
NameX =input('\033[1;97m[+]\033[1;92m YOUR NAME \033[1;91m: \033[1;96m')
#---------------------[LOOP MENU]---------------------#
loop = 0
cp = []
ok = []
...
def main():
    ...
    clear()
    print (' \t           \033[1;37m  \n                [ \033[1;31m  MENU \033[1;37m]')
    print('\033[1;32m--------------------------------------------------------------') 
    print(f"\033[1;97m\n[1] \033[1;92m START CLONING")
    print(f"\033[1;97m[2]\033[1;92m )
    print(f"\033[1;97m[0]\033[1;92m  EXIT \n  ")
    print('\033[1;32m-------------------------------------------------------------- \n ') 
    mirwais = input("\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m SELECT \033[1;37m: \033[1;36m")
    if mirwais in ["1","01"]:
        passx()
    elif mirwais in ["2","02"]:
        os.system("xdg-open https://t.me/kingAmir_01")
        main()
...
def passx():
    ...
    print('\033[1;32m--------------------------------------------------------------') 
    print("\033[1;97m[1] \033[1;93mM 1 ")
    print("\033[1;97m[2] \033[1;93mM 2")
    print('\033[1;32m--------------------------------------------------------------') 
